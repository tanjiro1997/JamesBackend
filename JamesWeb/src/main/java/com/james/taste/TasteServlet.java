...
public class TasteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map<String, String> foodsMap = new HashMap<String, String>();
		foodsMap.put("jjm", "짜장면");
		foodsMap.put("jb", "짬뽕");
		foodsMap.put("tsy", "탕수육");
		foodsMap.put("mpdb", "마파두부");
		foodsMap.put("pbc", "팔보채");
		
		
		String foodStr="";
		for(String food : foods) {
			foodStr += foodsMap.get(food) +", ";
		}
